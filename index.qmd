...
- [Slide Deck: Python for MBA Students](slides/python-overview.html){target="_blank"}
- [Companion Exercises (Google Colab)](https://colab.research.google.com/github/kerryback/workshop_python/blob/main/python_overview_exercises.ipynb){target="_blank"}
...
- [Python for Data Analysis](https://wesmckinney.com/book/) — another free online book, written by the creator of pandas, who used to be at AQR
