...
\begin{itemize}
\item Get company financial and stock price data from an online SQL database
\item Train a machine learning model to value stocks based on fundamentals
\item Create an app that deploys the model and sends a list of "mispriced" stocks to an LLM for a written analysis
\end{itemize}

\newpage

\section*{Day 3 Morning: Financial Applications}

Participants will analyze three financial cases using Windsurf, Claude Code, and Excel.   The presumption is that most participants will have some knowledge of financial ratios and discounted cash flow calculations, but pre-workshop prep materials will be provided to level up participants' understanding. The cases are Harvard Business School Press cases and will be provided to participants in advance.  They cover financial statement analysis, valuing companies by discounting cash flows, and capital budgeting.  
  
\begin{itemize}
\item Case 1: Costco Wholesale Corporation Financial Statement Analysis
\item Case 2: Valuing Walmart 2010
\item Case 3: The Sneaker Project
\end{itemize}

\textbf{Method of Instruction:}

\begin{itemize}
\item Group break-outs for case analysis using Windsurf, Claude Code, and Excel
\item In-class discussions of cases and techniques
\end{itemize}

\textbf{Learning Objectives:}

\begin{itemize}
\item How to use AI for different financial applications
\item Gain experience in financial statement analysis, discounted cash flow valuation, and capital budgeting
\item Gain experience working in Excel while collaborating with AI that uses python 
\end{itemize}

\section*{Day 3 Afternoon: Capstone}
